...
- Planning Core production-order proposal endpoint added:
  ...
  - Compact/full parity regression now additionally covers profile-based direct scenarios (stockout/balanced/overstock style demand-stock inputs) and asserts Layer 2 `decision_quality` diagnostics are retained in compact metadata.
