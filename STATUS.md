...
- Planning Core production-order proposal endpoint added:
  ...
  - Stable-alpha acceptance checklist now marks Layer 2/Layer 3/Layer 4/Layer 5/explainability contract criteria, from-WB freshness criteria, decision-quality casebook evidence, Economic Alpha transition-block criteria, and verification gate criteria as complete based on locked regressions and successful `verify`/`verify-live` runs.
