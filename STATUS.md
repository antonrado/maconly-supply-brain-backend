...
- Planning Core production-order proposal endpoint added:
  ...
  - Layer 2 contract summary is now emitted in `explanation.meta.layer_2_allocation.contract` (version/status/checks for summary consistency, valid decisions, non-negative metrics, positive ETA, and tie-break invariants) and projected in compact explainability mode.
