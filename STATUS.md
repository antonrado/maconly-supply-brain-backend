...
- Planning Core production-order proposal endpoint added:
  ...
  - Stable-alpha acceptance checklist now marks Layer 2 contract criteria, decision-quality casebook evidence, and Economic Alpha transition-block criteria as complete based on locked regressions and canonical contract outputs.
